...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "day20/test/integration/FirstJourney",
    "day20/test/integration/PurchaseOrdersListJourney",
    "day20/test/integration/PurchaseOrdersObjectPageJourney",
    "day20/test/integration/PurchaseOrderItemsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
